...
/**
 * The {@link IOnStrokePolicy} can be used to process key presses and
 ...
 * pressed keys, you can use {@link IOnTypePolicy} instead.
 *
 * @author mwienand
 *
 */
public interface IOnStrokePolicy extends IPolicy {
