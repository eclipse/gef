...
public class ResizeBendablePolicy extends ResizePolicy {
	...
	protected ITransactionalOperation createOperation() {
		return new BendConnectionOperation(getHost().getVisual());
	}
	 ...
	 *
	 * @return The {@link BendConnectionOperation} used to resize the visual.
	 */
	...
	protected List<Integer> getIndicesOfMovableAnchors() {
		BendConnectionOperation op = getBendConnectionOperation();
	...
	protected void updateResizeOperation(double dw, double dh) {
		BendConnectionOperation bendConnectionOperation = getBendConnectionOperation();
		for (int i : getIndicesOfMovableAnchors()) {
