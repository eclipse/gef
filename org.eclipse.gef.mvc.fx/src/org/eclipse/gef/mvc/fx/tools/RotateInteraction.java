...
/**
 * The {@link RotateInteraction} is an {@link AbstractInteraction} to handle rotate
 * interaction gestures.
 * <p>
 * The {@link RotateInteraction} handles the opening and closing of an transaction
		...
		ChangeListener<Boolean> viewerFocusChangeListener = new ChangeListener<Boolean>() {
			...
			public void changed(ObservableValue<? extends Boolean> observable,
				...
				if (newValue == null || !newValue) {
					...
					getDomain().closeExecutionTransaction(RotateInteraction.this);
				}
			}
		};
		...
		return new EventHandler<RotateEvent>() {
			...
			public void handle(RotateEvent event) {
				...
				if (RotateEvent.ROTATE.equals(event.getEventType())) {
					...
					if (!getDomain()
							.isExecutionTransactionOpen(RotateInteraction.this)) {
						...
						getDomain().openExecutionTransaction(RotateInteraction.this);
					}
