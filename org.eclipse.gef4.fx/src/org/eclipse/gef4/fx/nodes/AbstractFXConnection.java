...
public abstract class AbstractFXConnection<T extends ICurve> extends Group implements IFXConnection {
    ...
    // anchors
    protected ReadOnlyObjectWrapper<AnchorLink> startAnchorLinkProperty = new ReadOnlyObjectWrapper<AnchorLink>(null);
    protected ReadOnlyObjectWrapper<AnchorLink> endAnchorLinkProperty = new ReadOnlyObjectWrapper<AnchorLink>(null);
    ...
    // anchor management
    private ReadOnlyObjectWrapper<ChangeListener<? super AnchorLink>> onStartAnchorLinkChangeProperty =
            new ReadOnlyObjectWrapper<ChangeListener<? super AnchorLink>>(null);
    private ReadOnlyObjectWrapper<ChangeListener<? super AnchorLink>> onEndAnchorLinkChangeProperty =
            new ReadOnlyObjectWrapper<ChangeListener<? super AnchorLink>>(null);
    private ReadOnlyObjectWrapper<ListChangeListener<? super AnchorLink>> onWayPointAnchorLinkChangeProperty =
            new ReadOnlyObjectWrapper<ListChangeListener<? super AnchorLink>>(null);

    // refresh geometry on position changes
    protected MapChangeListener<? super AnchorKey, ? super Point> positionChangeListener =
            new MapChangeListener<AnchorKey, Point>() {
                @Override
...

    {
        ...
        wayPointAnchorLinksProperty.addListener(new ListChangeListener<AnchorLink>() {
            @Override
            public void onChanged(javafx.collections.ListChangeListener.Change<? extends AnchorLink> c) {
                refreshGeometry();
            }
        });
    }
    ...
    public void addWayPointAnchorLink(int index, AnchorLink wayPointAnchorLink) {
        ...
        wayPointAnchorLink.getAnchor().positionProperty().addListener(positionChangeListener);
    }
     ...
     */
    protected Point arrangeDecoration(IFXDecoration deco, Point start, Vector direction, Point decoStart,
    ...
    protected void arrangeEndDecoration() {
        ...
        arrangeDecoration(endDecoration, endPoint, endDirection, decoStartPoint, decoDirection);
    }
    ...
    protected void arrangeStartDecoration() {
        ...
        arrangeDecoration(startDecoration, startPoint, curveStartDirection, decoStartPoint, decoDirection);
    }
    ...
    @Override
    public AnchorLink createWayPointAnchorLink(Point wayPointInLocal) {
        FXStaticAnchor anchor =
                new FXStaticAnchor(JavaFX2Geometry.toPoint(localToScene(wayPointInLocal.x, wayPointInLocal.y)));
    ...
    public void removeWayPoint(int index) {
        ...
        if (index < 0 || index >= wayPointAnchorLinksProperty.get().size()) {
            throw new IllegalArgumentException("Index out of range (index: " + index + ", size: "
                    + wayPointAnchorLinksProperty.size() + ").");
        }
    ...
    public void setEndAnchor(IFXAnchor endAnchor) {
        setEndAnchorLink(new AnchorLink(endAnchor, new AnchorKey(this, END_ROLE)));
    }

    @Override
    public void setEndAnchorLink(AnchorLink endAnchorLink) {
        if (endAnchorLink == null) {
            throw new IllegalArgumentException("The given AnchorLink may not be <null>.");
        }

        // unregister change listener on old link
        AnchorLink oldLink = endAnchorLinkProperty.get();
        ChangeListener<? super AnchorLink> listener = onEndAnchorLinkChangeProperty.get();
        if (oldLink != null) {
            endAnchorLinkProperty.get().getAnchor().positionProperty().removeListener(positionChangeListener);
            if (listener != null) {
        ...
        endAnchorLinkProperty.get().getAnchor().positionProperty().addListener(positionChangeListener);
        refreshGeometry();
    }
    ...
    public void setEndDecoration(IFXDecoration endDeco) {
        ...
        if (endDecoration != null) {
            ObservableList<String> styleClasses = endDecoration.getVisual().getStyleClass();
    ...
    public void setEndPoint(Point endPointInLocal) {
        ...
        FXStaticAnchor anchor =
                new FXStaticAnchor(JavaFX2Geometry.toPoint(localToScene(endPointInLocal.x, endPointInLocal.y)));
        setEndAnchorLink(new AnchorLink(anchor, key));
    }

    @Override
    public void setOnEndAnchorLinkChange(ChangeListener<? super AnchorLink> onEndAnchorLinkChange) {
        // unregister old listener
        ChangeListener<? super AnchorLink> oldListener = onEndAnchorLinkChangeProperty.get();
        if (oldListener != null) {
    ...
    @Override
    public void setOnStartAnchorLinkChange(ChangeListener<? super AnchorLink> onStartAnchorLinkChange) {
        // unregister old listener
        ChangeListener<? super AnchorLink> oldListener = onStartAnchorLinkChangeProperty.get();
        if (oldListener != null) {
    ...
    @Override
    public void setOnWayPointAnchorLinkChange(ListChangeListener<? super AnchorLink> onWayPointChange) {
        ListChangeListener<? super AnchorLink> oldListener = onWayPointAnchorLinkChangeProperty.get();
        if (oldListener != null) {
    ...
    public void setStartAnchor(IFXAnchor startAnchor) {
        setStartAnchorLink(new AnchorLink(startAnchor, new AnchorKey(this, START_ROLE)));
    }
    ...
    public void setStartAnchorLink(AnchorLink startAnchorLink) {
        ...
        ChangeListener<? super AnchorLink> listener = onStartAnchorLinkChangeProperty.get();
        if (oldLink != null) {
            startAnchorLinkProperty.get().getAnchor().positionProperty().removeListener(positionChangeListener);
            if (listener != null) {
        ...
        startAnchorLinkProperty.get().getAnchor().positionProperty().addListener(positionChangeListener);
        refreshGeometry();
    }
    ...
    public void setStartDecoration(IFXDecoration startDeco) {
        ...
        if (startDecoration != null) {
            ObservableList<String> styleClasses = startDecoration.getVisual().getStyleClass();
            if (!styleClasses.contains(CSS_CLASS_DECORATION)) {
                styleClasses.add(CSS_CLASS_DECORATION);
            }
        }
    ...
    public void setStartPoint(Point startPointInLocal) {
        ...
        FXStaticAnchor anchor =
                new FXStaticAnchor(JavaFX2Geometry.toPoint(localToScene(startPointInLocal.x, startPointInLocal.y)));
        setStartAnchorLink(new AnchorLink(anchor, key));
    }

    @Override
    public void setWayPoint(int index, Point wayPointInScene) {
        setWayPointAnchorLink(index, createWayPointAnchorLink(wayPointInScene));
    }
