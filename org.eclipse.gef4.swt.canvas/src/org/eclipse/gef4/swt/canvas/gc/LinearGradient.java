 ...
 * {@link org.eclipse.gef4.swt.canvas.gc.GradientStop GradientStop}s which
...
public class LinearGradient extends Gradient<LinearGradient> {
	...
	/**
	 * <p>
	 * Constructs a new {@link org.eclipse.gef4.swt.canvas.gc.LinearGradient
	 * LinearGradient} representing a {@link Gradient} from the given start
	 * {@link Point} to the given end {@link Point}.
	 * </p>
	 * 
	 * <p>
	 * The {@link org.eclipse.gef4.swt.canvas.gc.GradientStop GradientStop}s can
	 ...
	 * the given {@link org.eclipse.gef4.swt.canvas.gc.CycleMethod CycleMethod}.
	 * </p>
	 * 
	 * <p>
	 * The {@link org.eclipse.gef4.swt.canvas.gc.GradientStop GradientStop}s can
	 ...
	 *            the {@link Point} at which the {@link LinearGradient} ends
	 * @param cycleMode
	 *            the {@link org.eclipse.gef4.swt.canvas.gc.CycleMethod} which
