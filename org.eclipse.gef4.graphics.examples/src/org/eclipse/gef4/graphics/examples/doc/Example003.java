...
public class Example003 implements IExample {

	public static void main(String[] args) {
		new SwtExample(new Example003());
	}
	...
	public String getTitle() {
		return "Example 003 - Gradient.Radial";
	}
	...
	public void renderScene(IGraphics g) {
		...
		Gradient.Radial radialGradient = new Gradient.Radial(ellipse,
				ellipse.getCenter()).addStop(0.0, new Color(255, 255, 255))
