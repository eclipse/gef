...
<sub>Please note that in the <a href="https://projects.eclipse.org/projects/tools.gef/releases/4.0.0-neon">4.x (Neon)</a> maintenance stream, the code base still refers to 'GEF4' respectively <code>org.eclipse.gef4</code>, while in the <a href="https://projects.eclipse.org/projects/tools.gef/releases/5.0.0-oxygen">5.x (Oxygen)</a> development stream, the original project namespace has been adopted, so that 'GEF' and <code>org.eclipse.gef</code> are now used.</sub>
