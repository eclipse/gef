...
public abstract class AbstractLayoutExample extends Application {
	...
	public AbstractLayoutExample(String title) {
		this.title = title;
	}
	...
	public void start(final Stage primaryStage) throws Exception {
		...
		Injector injector = Guice.createInjector(new ZestFxModule());
