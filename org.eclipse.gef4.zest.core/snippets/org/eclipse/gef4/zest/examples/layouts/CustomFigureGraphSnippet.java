...
public class CustomFigureGraphSnippet {
	...
	public static void main(String[] args) {
		...
		Image zx = new Image(Display.getDefault(),
				ContainerResizeGraphSnippet.class.getResourceAsStream("zx.png"));
		Image ibull = new Image(Display.getDefault(),
				ContainerResizeGraphSnippet.class
						.getResourceAsStream("ibull.jpg"));
