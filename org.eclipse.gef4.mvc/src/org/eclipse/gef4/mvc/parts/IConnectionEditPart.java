 ...
 * looks first in the
 * {@link org.eclipse.gef4.mvc.partviewer.IEditPartViewer#getEditPartRegistry() EditPartRegistry}
...
public interface IConnectionEditPart<V> extends IContentsEditPart<V> {
	 ...
	 */
	void setSource(INodeEditPart<V> source);
	 ...
	 */
	void setTarget(INodeEditPart<V> target);
}
