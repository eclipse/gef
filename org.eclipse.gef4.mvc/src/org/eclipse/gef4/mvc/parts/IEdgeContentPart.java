...
/**
 * A specialization of {@link IGraphicalEditPart GraphicalEditPart} for
 ...
 * looks first in the
 * {@link org.eclipse.gef4.mvc.partviewer.IVisualPartViewer#getContentPartMap() EditPartRegistry}
...
public interface IEdgeContentPart<V> extends IContentPart<V> {
	 ...
	 */
	// TODO: change to add source /and remove source
	void setSource(INodeContentPart<V> source);
	 ...
	 */
	void setTarget(INodeContentPart<V> target);
}
