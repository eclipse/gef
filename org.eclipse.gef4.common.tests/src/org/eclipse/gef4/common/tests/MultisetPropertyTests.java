...
public class MultisetPropertyTests {
	...
	public void changeNotifications() {
		...
		multisetChangeListener.addExpectation(4, 0, 4);
		multisetChangeListener.addExpectation(5, 0, 5);
		multisetChangeListener.addExpectation(6, 0, 6);
		...
		multisetChangeListener.addExpectation(4, 2, 0);
		multisetChangeListener.addExpectation(6, 0, 2);
		multisetChangeListener.addExpectation(7, 0, 7);
		property.set(newValue);
		invalidationListener.check();
		multisetChangeListener.check();
		changeListener.check();
		...
		multisetChangeListener.addExpectation(4, 2, 0);
		multisetChangeListener.addExpectation(5, 5, 0);
		multisetChangeListener.addExpectation(6, 8, 0);
		multisetChangeListener.addExpectation(7, 7, 0);
		property.set(null);
		invalidationListener.check();
		multisetChangeListener.check();
		changeListener.check();
