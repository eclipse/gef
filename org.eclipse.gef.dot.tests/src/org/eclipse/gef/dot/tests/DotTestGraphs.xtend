...
/*
 ************************************************************************************************************
 * Test strings with embedded dot graphs
 ************************************************************************************************************
 */
 
 	public static val EMBEDDED_01 = '''
		/** 
			Javadoc stuff 
				graph name {
					a;
 	...
 	public static val EXTRACTED_01 = '''
		graph name {
					a;
					b;
					a--b
	...
	public static val EXTRACTED_02 = '''
		graph long_name {
			a;
			b;
			a--b
	...
	public static val EXTRACTED_03 = '''
		digraph {
			a;
			b;
			a->b
	...
	public static val EXTRACTED_04 = '''
		graph {
			a;
			b;
			a--b
	...
	public static val EXTRACTED_05 = '''
		graph{
				a
				b
				a--b
	...
	public static val EMBEDDED_06 = '''
		Stuff about a graph and then digraph{a;b;a->b} and more 
	'''
	
	public static val EXTRACTED_06 = '''
		digraph{a;b;a->b}
	'''
	
	public static val EMBEDDED_07 = '''
		Stuff about a graph and then 
		digraph {
			subgraph cluster_0 {
				1->2
	...
	public static val EXTRACTED_07 = '''
		digraph {
			subgraph cluster_0 {
				1->2
			}; 
	...
	public static val EXTRACTED_08 = '''
		graph {
				node[shape=record];
				1[label="{Text|Text}"]
			}
