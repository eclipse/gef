...
class DotColorUtilTests {

	@Inject extension ParseHelper<Color>
	@Inject extension ValidationTestHelper
	val dotColorUtil = new DotColorUtil

	@Test def test_RGBColor_white_to_zest_color() {
		"#ffffff".testZestColor("#ffffff")
	}

	@Test def test_RGBColor_black_to_zest_color() {
		"#000000".testZestColor("#000000")
	}

	@Test def test_RGBColor_red_to_zest_color() {
		"#ff0000".testZestColor("#ff0000")
	}

	@Test def test_RGBColor_turquoise_to_zest_color() {
		"#40e0d0".testZestColor("#40e0d0")
	}

	@Test def test_RGBColor_sienna_to_zest_color() {
		"#a0522d".testZestColor("#a0522d")
	}

	@Test def test_HSVColor_white_to_zest_color() {
		"0.000 0.000 1.000".testZestColor("hsb(0.0, 0.0%, 100.0%)")
	}

	@Test def test_HSVColor_black_to_zest_color() {
		"0.000 0.000 0.000".testZestColor("hsb(0.0, 0.0%, 0.0%)")
	}

	@Test def test_HSVColor_red_to_zest_color() {
		"0.000 1.000 1.000".testZestColor("hsb(0.0, 100.0%, 100.0%)")
	}

	@Test def test_HSVColor_turquoise_to_zest_color() {
		"0.482 0.714 0.878".testZestColor("hsb(173.51999999999998, 71.39999999999999%, 87.8%)")
	}

	@Test def test_HSVColor_sienna_to_zest_color() {
		"0.051 0.718 0.627".testZestColor("hsb(18.36, 71.8%, 62.7%)")
	}

	@Test def test_StringColor_white_to_zest_color() {
		"white".testZestColor("#ffffff")
	}

	@Test def test_StringColor_black_to_zest_color() {
		"black".testZestColor("#000000")
	}

	@Test def test_StringColor_red_to_zest_color() {
		"red".testZestColor("#ff0000")
	}

	@Test def test_StringColor_turquoise_to_zest_color() {
		"turquoise".testZestColor("#40e0d0")
	}

	@Test def test_StringColor_sienna_to_zest_color() {
		"sienna".testZestColor("#a0522d")
	}

	@Test def test_RGBColor_white_to_graph_background_color() {
		"#ffffff".testGraphBackgroundColor("0xffffffff")
	}

	@Test def test_RGBColor_black_to_graph_background_color() {
		"#000000".testGraphBackgroundColor("0x000000ff")
	}

	@Test def test_RGBColor_red_to_graph_background_color() {
		"#ff0000".testGraphBackgroundColor("0xff0000ff")
	}

	@Test def test_RGBColor_turquoise_to_graph_background_color() {
		"#40e0d0".testGraphBackgroundColor("0x40e0d0ff")
	}

	@Test def test_RGBColor_sienna_to_graph_background_color() {
		"#a0522d".testGraphBackgroundColor("0xa0522dff")
	}

	@Test def test_HSVColor_white_to_graph_background_color() {
		"0.000 0.000 1.000".testGraphBackgroundColor("0xffffffff")
	}

	@Test def test_HSVColor_black_to_graph_background_color() {
		"0.000 0.000 0.000".testGraphBackgroundColor("0x000000ff")
	}

	@Test def test_HSVColor_red_to_graph_background_color() {
		"0.000 1.000 1.000".testGraphBackgroundColor("0xff0000ff")
	}

	@Test def test_HSVColor_turquoise_to_graph_background_color() {
		// TODO: check the small differences, should be 0x40e0d0ff
		"0.482 0.714 0.878".testGraphBackgroundColor("0x40e0cfff")
	}

	@Test def test_HSVColor_sienna_to_graph_background_color() {
		// TODO: check the small differences, should be 0xa0522dff
		"0.051 0.718 0.627".testGraphBackgroundColor("0xa0502dff")
	}

	@Test def test_StringColor_white_to_graph_background_color() {
		"white".testGraphBackgroundColor("0xffffffff")
	}

	@Test def test_StringColor_black_to_graph_background_color() {
		"black".testGraphBackgroundColor("0x000000ff")
	}

	@Test def test_StringColor_red_to_graph_background_color() {
		"red".testGraphBackgroundColor("0xff0000ff")
	}

	@Test def test_StringColor_turquoise_to_graph_background_color() {
		"turquoise".testGraphBackgroundColor("0x40e0d0ff")
	}

	@Test def test_StringColor_sienna_to_graph_background_color() {
