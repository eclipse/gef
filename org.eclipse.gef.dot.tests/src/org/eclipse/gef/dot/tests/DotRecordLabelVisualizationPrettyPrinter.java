...
public class DotRecordLabelVisualizationPrettyPrinter {
	 ...
	 */
	public DotRecordLabelVisualizationPrettyPrinter() {
	 ...
	 */
	public DotRecordLabelVisualizationPrettyPrinter(String indent,
