 ...
 * add additional functionality (e.g: Image Registry initialization). The
 * DotActivatorEx class should be registered in the MANIFEST.MF file as the
 * activator of the <i>org.eclipse.gef.dot.ui</i> plugin.
 */
