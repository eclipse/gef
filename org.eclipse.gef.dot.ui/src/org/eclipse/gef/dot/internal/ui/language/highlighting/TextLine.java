...
/**
 * The implementation of this class is taken from the
 * {org.eclipse.xtend.core.richstring.TextLine} class.
 */
public class TextLine implements CharSequence {

	protected static class LeadingWSTextLinePart extends TextLine {

		public LeadingWSTextLinePart(String completeText, int offset,
				int length) {
	...
	public TextLine(String completeText, int offset, int length,
			int delimiterLength) {
	...
	public boolean equals(Object obj) {
		...
		if (delimiterLength != other.delimiterLength)
			return false;
		if (!completeText.regionMatches(offset, other.completeText,
				other.offset, length))
			return false;
		return true;
	}
	...
	protected void throwIndexOutOfBounds(int offset) {
		throw new IndexOutOfBoundsException(("Index out of range: " + offset)); //$NON-NLS-1$
	}
